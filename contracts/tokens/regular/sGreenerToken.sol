...
contract sGreener is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Greener, "sGreener", 9) ERC20Permit() {
    ...
    /**
        @notice increases sGreener supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sGreener
